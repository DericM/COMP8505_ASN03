...
int main(int argc, char *argv[])
{
    ...
    /*
    std::string data = "Lorem ipsum dictum sapien pharetram sapien pharetram sapien pharetram sapien pharetra ";
    std::string encrypted = xor_data(data.c_str()); 
    std::cout << encrypted << std::endl;
    std::string decrypted = xor_data(encrypted.c_str());
    std::cout << decrypted << std::endl;
    */

    //int rc = start_encrypt("Lorem ipsum dictum sapien pharetra etiam condimentum .", encrypted);
    //printf("%s\n%d\n", encrypted, rc);
    //rc = start_decrypt(encrypted, rc);
